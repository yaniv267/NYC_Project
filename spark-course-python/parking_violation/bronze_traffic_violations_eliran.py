...
from nyc_schema_eliran import bronze_parking_schema

# --- CONFIGURATION ---
KAFKA_BOOTSTRAP_SERVERS = "course-kafka:9093"
KAFKA_TOPIC = "nyc_parking_violations_bronze_new"
MINIO_OUTPUT_PATH = "s3a://spark/bronze/nyc_parking_violation_new/"
CHECKPOINT_PATH = "s3a://spark/bronze/nyc_parking_violation_new/_checkpoints/"
